...
- For every weather request, always call the appropriate MCP weather tool, even if the location appears misspelled, invalid, ambiguous, or unlikely to exist. Do not decide on your own that a location is invalid.
